...
class ChatAdapter(private val listener: (ChatItem) -> Unit) :
    ...
    fun updateData(data: List<ChatItem>) {
        Log.d(
            "ChatAdapter", "update data adapter - new data ${data.size} hash: ${data.hashCode()} " +
    ...
    abstract class ChatItemViewHolder(convertView: View) : RecyclerView.ViewHolder(convertView),
        LayoutContainer {
    ...
    class SingleViewHolder(convertView: View) : ChatItemViewHolder(convertView),
        ItemTouchViewHolder {
    ...
    class GroupViewHolder(convertView: View) : ChatItemViewHolder(convertView),
        ItemTouchViewHolder {
